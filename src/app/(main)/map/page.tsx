        ...
        <section className="p-4 absolute top-16 lg:left-[16.666%] lg:p-8 flex flex-col gap-2 w-full lg:w-5/6">
            ...
            <div className="flex flex-col space-y-8 items-center mx-auto">
                <div className="flex flex-col space-y-4 items-center mx-auto">
                    <h2 className="text-lg font-semibold">To get started, enter a paper identifier</h2>
                    <PaperSeedSearch />
                </div>
                <div className="flex flex-col space-y-4 items-center mx-auto">
                    <h3 className="text-base font-medium">Scholar Maps supports the following identifiers:</h3>
