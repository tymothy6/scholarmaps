      ...
      <Card>
        <Table>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell className="font-medium">
                The SAS interface is down, bypass the open-source pixel so we
                can backup the mainframe.
              </TableCell>
            ...
            <TableRow>
              <TableCell className="font-medium">
                The UTF8 application is down, parse the neural bandwidth so we
                can parse the exabyte!
              </TableCell>
            ...
            <TableRow>
              <TableCell className="font-medium">
                Generating the driver won’t do anything, we need to quantify the
                pixels in 1080p!
              </TableCell>
