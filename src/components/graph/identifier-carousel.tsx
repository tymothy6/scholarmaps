...
export function PaperIdentifierCarousel({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col space-y-4 items-center w-full md:mx-auto",
        className,
      )}
    >
      <h3 className="text-sm md:text-base font-medium">
        Scholar Maps supports the following
        <HoverCard>
          <HoverCardTrigger className="ml-1 underline underline-offset-2 cursor-pointer">
            identifiers:
          </HoverCardTrigger>
          <HoverCardContent>
            <div className="space-y-1">
              <p className="text-sm">
                Semantic Scholar (and Corpus), DOI, arXiv, Microsoft Academic
                Graph, PubMed/Medline, PubMed Central, Assoc. for Computational
                Linguistics
              </p>
